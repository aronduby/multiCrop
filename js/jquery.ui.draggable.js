...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_setContainment: function() {
		...
		if ( o.containment.container === "window" ) {
			this.containment = [
		...
		if ( o.containment.container === "document") {
			this.containment = [
				0,
				0,
		...
		if ( o.containment.container.constructor === Array ) {
			this.containment = o.containment;
			return;
		}

		if ( o.containment.container === "parent" ) {
			o.containment.container = this.helper[ 0 ].parentNode;
		}

		c = $( o.containment.container );
		ce = c[ 0 ];
